...
-- Joining retirement_info and dept_emp tables but with aliases to clean up code
SELECT ri.emp_no,
    ri.first_name,
ri.last_name,
    de.to_date
...
---- Joining departments and dept_manager tables but with aliases to clean up code
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Create new table with employee count by department number
SELECT COUNT(ce.emp_no), de.dept_no
INTO retirement_info_dept_count
